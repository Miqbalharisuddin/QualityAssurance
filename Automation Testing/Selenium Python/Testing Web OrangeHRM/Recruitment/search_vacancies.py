...
class TestMenuRecruitment(unittest.TestCase):

    def setUp(self):
        self.browser = webdriver.Chrome(ChromeDriverManager().install())

    def test_menuRecruitment(self):
        ...
        time.sleep(8)
        # validasi
        expectedURL = "https://opensource-demo.orangehrmlive.com/web/index.php/recruitment/viewCandidates"
