...
class TestLogin(unittest.TestCase):
    ...
    def test_02_failed_login_invalid_username(self):
        ...
        time.sleep(1)
        # isi username
        browser.find_element(By.ID, "txt-username").send_keys("Joko")
        time.sleep(1)
        # isi password
        browser.find_element(
            By.ID, "txt-password").send_keys("ThisIsNotAPassword")
        ...
        response_message = browser.find_element(
            By.XPATH, "/html/body/section/div/div/div[1]/p[2]").text
        self.assertEqual(
    ...
    def test_03_failed_login_invalid_password(self):
        ...
        # isi password
        browser.find_element(
            By.ID, "txt-password").send_keys("Pasukanhitam")
        time.sleep(1)
        # klik tombol sign in
        browser.find_element(By.ID, "btn-login").click()
        time.sleep(1)
    ...
    def test_04_failed_login_invalid_username_password(self):
        ...
        time.sleep(1)
        # isi username
        browser.find_element(By.ID, "txt-username").send_keys("Jawajawa")
        time.sleep(1)
        # isi password
        browser.find_element(
            By.ID, "txt-password").send_keys("wasweswos")
        time.sleep(1)
        # klik tombol sign in
        browser.find_element(By.ID, "btn-login").click()
        time.sleep(1)
    ...
    def test_05_failed_login_with_blank_username_password(self):
        ...
        time.sleep(1)
        # isi username
        browser.find_element(By.ID, "txt-username").send_keys("")
        time.sleep(1)
        # isi password
        browser.find_element(
            By.ID, "txt-password").send_keys("")
        time.sleep(1)
        # klik tombol sign in
        browser.find_element(By.ID, "btn-login").click()
        time.sleep(1)
