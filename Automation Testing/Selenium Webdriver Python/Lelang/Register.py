...
class TestRegister(unittest.TestCase):
    ...
    def test_success_register(self):
        ...
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[2]/div[2]/form/div[3]/i").click()
        time.sleep(2)
        # pilih item dropdown provinsi
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[2]/div[2]/form/div[3]/div[1]").click()
        time.sleep(2)
        # klik dropdown kabupaten
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[2]/i").click()
        time.sleep(2)
        # pilih item dropdown kabupaten
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[2]").click()
        time.sleep(2)
        # isi kode pos
        ...
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]").click()
        ...
        time.sleep(2)
        # isi No Rekening
        browser.find_element(By.ID, "norek_id").send_keys("33333678678923456")
        time.sleep(1)
        # isi Nama Rekening
        browser.find_element(By.ID, "rek_id").send_keys("M Iqbal Harisuddin")
        time.sleep(1)
        # isi Password
        ...
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[3]").click()
        time.sleep(2)
        # klik menyetujui ketentuan
        browser.find_element(
            By.XPATH, "/html/body/div/div[1]/div/div[1]/div/div[4]").click()
        time.sleep(2)
        # klik tombol Daftar
